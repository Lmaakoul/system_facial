...
function Abscent() {
  const [abscentData, setAbscentData] = useState([]);
  const [editData, setEditData] = useState({});
  const [isEditModalOpen, setIsEditModalOpen] = useState(false);
  const [isDeleteModalOpen, setIsDeleteModalOpen] = useState(false);
  const [deleteItemId, setDeleteItemId] = useState(null); // to store the id of the item to delete
  ...
  return (
    <div>
      <Typography variant="h3" gutterBottom>Abscent Data</Typography>
